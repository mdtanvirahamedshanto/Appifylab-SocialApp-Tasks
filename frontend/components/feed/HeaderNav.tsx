...
const notifications = [
  ...
  },
  {
    ...
    content: (
      <>
        An admin changed the name of the group <span className="_notify_txt_link">Freelacer usa</span> to{" "}
...
function NotificationItem({ image, children }: { image: string; children: ReactNode }) {
  return (
    <div className="_notification_box">
      <div className="_notification_image">
        <img src={`/buddy-script/assets/images/${image}`} alt="Image" className="_notify_img" />
      </div>
      <div className="_notification_txt">
        <p className="_notification_para">{children}</p>
      ...
      <div className="container _custom_container">
        <div className="_logo_wrap">
          <a className="navbar-brand" href="/feed">
            <img src="/buddy-script/assets/images/logo.svg" alt="Image" className="_nav_logo" />
          </a>
        </div>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
            ...
            <li className="nav-item _header_nav_item">
              <span id="_notify_btn" className="nav-link _header_nav_link _header_notify_btn" onClick={onToggleNotify}>
                ...
                <div id="_notify_drop" className={`_notification_dropdown ${showNotify ? "show" : ""}`}>
                  ...
                  <div className="_notifications_drop_box">
                    ...
                    {notifications.map((item, index) => (
                      <NotificationItem key={`notify-${index}`} image={item.image}>
                        {item.content}
                      </NotificationItem>
                    ))}
                  </div>
            ...
            <li className="nav-item _header_nav_item">
              <a className="nav-link _header_nav_link" href="messages.html">
          ...
          <div className="_header_nav_profile">
            <div className="_header_nav_profile_image">
              <img src="/buddy-script/assets/images/profile.png" alt="Image" className="_nav_profile_img" />
            </div>
            <div className="_header_nav_dropdown">
              <p className="_header_nav_para">{displayName}</p>
              <button id="_profile_drop_show_btn" className="_header_nav_dropdown_btn _dropdown_toggle" type="button" onClick={onToggleProfile}>
            ...
            <div id="_prfoile_drop" className={`_nav_profile_dropdown _profile_dropdown ${showProfileMenu ? "show" : ""}`}>
              <div className="_nav_profile_dropdown_info">
                <div className="_nav_profile_dropdown_image">
                  <img src="/buddy-script/assets/images/profile.png" alt="Image" className="_nav_drop_img" />
                </div>
              ...
              <ul className="_nav_dropdown_list">
                ...
                <li className="_nav_dropdown_list_item">
                  <button type="button" className="_nav_dropdown_link" onClick={onLogout}>
                    <div className="_nav_drop_info">
                      <span>
