...
-- CreateEnum
CREATE TYPE "LikeType" AS ENUM ('POST', 'COMMENT', 'REPLY');
...
-- CreateIndex
CREATE UNIQUE INDEX "Reply_createdAt_id_key" ON "Reply"("createdAt", "id");

-- CreateIndex
CREATE INDEX "Like_userId_type_idx" ON "Like"("userId", "type");
